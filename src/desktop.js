...
},{"./lib/calls":3,"./lib/getpeerdata":4,"cog/extend":7,"mbus":12,"rtc-core/genice":14,"rtc-core/plugin":16,"rtc-pluggable-signaller":17,"rtc-tools":50}],3:[function(require,module,exports){
(function (process){
var rtc = require('rtc-tools');
var debug = rtc.logger('rtc-quickconnect');
...
},{"./getpeerdata":4,"./heartbeat":5,"_process":1,"cog/getable":8,"rtc-tools":50,"rtc-tools/cleanup":46}],4:[function(require,module,exports){
...
},{"cog/extend":7,"cog/getable":8,"cuid":19,"mbus":12,"pull-pushable":20,"pull-stream":27,"rtc-core/detect":13,"rtc-signal/prepare":34,"rtc-signal/signaller":36}],19:[function(require,module,exports){
/**
 * cuid.js
...
},{"./sinks":24,"./sources":25,"_process":1,"pull-core":23}],27:[function(require,module,exports){
var sources  = require('./sources')
var sinks    = require('./sinks')
var throughs = require('./throughs')
var u        = require('pull-core')
...
},{"./sinks":30,"./sources":31,"_process":1,"pull-core":29}],33:[function(require,module,exports){
var extend = require('cog/extend');
...
},{"cog/extend":7}],34:[function(require,module,exports){
/**
  ### prepare
...
},{"./handlers/announce":33,"cog/jsonparse":9}],36:[function(require,module,exports){
var detect = require('rtc-core/detect');
var extend = require('cog/extend');
var getable = require('cog/getable');
...
},{"./prepare":34,"./process":35,"cog/extend":7,"cog/getable":8,"cuid":19,"mbus":12,"rtc-core/detect":13}],37:[function(require,module,exports){
var extend = require('cog/extend');
...
},{"cog/extend":7,"messenger-ws":38}],38:[function(require,module,exports){
...
},{"cog/defaults":6,"pull-ws":39,"ws":44,"wsurl":45}],39:[function(require,module,exports){
...
},{"./ready":41,"_process":1,"pull-core":40}],43:[function(require,module,exports){
var pull = require('pull-core');
var ready = require('./ready');
...
},{"./camera":65,"./viewer":66}],65:[function(require,module,exports){
'use strict';

var quickconnect = require('rtc-quickconnect');

module.exports = function () {
  var room = 'oix1@lkjs8dcSd';
  // const width = 640
  // const height = 480
  ...
  if (navigator.getUserMedia) {
    navigator.getUserMedia({ audio: false, video: true }, function (stream) {
      ...
      quickconnect('https://switchboard.rtc.io/', { room: room }).addStream(stream).on('call:started', function (id, pc, data) {
...
},{"rtc-quickconnect":2}],66:[function(require,module,exports){
'use strict';

var THREE = window.THREE;
var WebVRManager = window.WebVRManager;
...
module.exports = function () {
  ...
  quickconnect('https://switchboard.rtc.io/', { room: room }).on('call:started', function (id, pc, data) {
